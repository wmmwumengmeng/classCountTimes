...
let classCountTimes = {
    ...
    getClassArr() {
        ...
        this.data.classArr = data.match(/\.[a-zA-Z0-9\.-]+(\s|\{|\:|\[|\,)/g);
        ...
        files.forEach((filename) => {
            ...
            if (isFile && isFileName) {
                ...
                for (let i = 0; i < this.data.classArr.length; i++) {
                    ...
                    let sClass4 = '-' + sClass;
                    // let sClass5 = sClass + '-';
                    let sClassNew = (!content.match(sClass4)) && (content.match(sClass1) || content.match(sClass2) || content.match(sClass3));
